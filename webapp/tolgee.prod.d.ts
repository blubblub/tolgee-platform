...
declare module '@tolgee/web' {
  ...
  type BlubBlubTranslationKey =
    ...
    | 'asset_translations_no_permission'
    ...
    | 'asset_translations_asset_name'
    | 'asset_translations_count'
    | 'asset_translations_empty'
    | 'asset_translations_expand_hint'
    | 'asset_translations_help'
    | 'asset_translations_languages'
    | 'asset_translations_load_failed'
    | 'asset_translations_loading_languages'
    | 'asset_translations_no_assets'
    | 'asset_translations_no_target_languages'
    | 'asset_translations_source_language'
    | 'asset_translations_status'
    | 'asset_translations_title'
    | 'project_menu_asset_translations'
